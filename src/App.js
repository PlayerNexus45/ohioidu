...
function Profile(token){
  ...
  .then((response) =>{
    ...
    element.innerHTML = `${str} <br/> Citizen ${profile.first_name} ${profile.last_name} ID: ${profile.id}, <br/> You have ${profile.unread_messages_count} unread messages, see to them at Your earliest convenience, <br/> `
  }
  )
}
